class ReaderMode {
  ...
  async createReaderMode(article) {
    ...
    outlineToggleButton.className = 'outline-toggle-button';
    ...
    this.readerContainer.appendChild(outlineToggleButton);
    this.readerContainer.appendChild(settingsButton);
    ...
    this.readerContainer.appendChild(imageToggleButton);
    this.readerContainer.appendChild(aiSummaryButton);
